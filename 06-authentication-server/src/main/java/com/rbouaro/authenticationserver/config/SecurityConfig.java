...
public class SecurityConfig {
	...
	// http://localhost:10010/oauth2/authorize?response_type=code&client_id=oidc-client&scope=openid&redirect_uri=https://springone.io/authorized&code_challenge=DTr0o7A8fCTE8l9vbiQ9sq6LulQd6j8PaFLlhYPnVgI&code_challenge_method=S256
	...
	public SecurityFilterChain appSecurityFilterChain(HttpSecurity http) throws Exception {
		return http
				.authorizeHttpRequests(authorize -> authorize
						.requestMatchers("/login", "/oauth2/consent").permitAll()
						.anyRequest().authenticated()
				)
